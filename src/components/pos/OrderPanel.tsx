...
import type { OrderItem, Sale } from '@/types';
import { Button } from '@/components/ui/button';
import { Card, CardContent, CardFooter, CardHeader, CardTitle } from '@/components/ui/card';
import { ScrollArea } from '@/components/ui/scroll-area';
import { Separator } from '@/components/ui/separator';
import { Minus, Plus, Trash2, ShoppingBag, ListRestart, History, Hand, Receipt } from 'lucide-react';
...
interface OrderPanelProps {
  ...
  heldOrders: { id: number, items: OrderItem[] }[];
  recentSales: Sale[];
...
function CurrentOrderView({ orderItems, onUpdateQuantity, onRemoveItem, onFinalize, onHold, t }: any) {
...
export function OrderPanel({ orderItems, heldOrders, recentSales, onUpdateQuantity, onRemoveItem, onFinalize, onHold, onResumeOrder, onDeleteHeldOrder }: OrderPanelProps) {
  const { t } = useSettings();
